RBJIT_CPPFLAGS = /wd4355 /I./rbjit /I./rbjit/include /I$(LLVM_PREFIX)/include /DNDEBUG /D_SCL_SECURE_NO_WARNINGS=1 /DRBJIT_ENABLED /GR /EHsc /D_SECURE_SCL=0 /D_HAS_ITERATOR_DEBUGGING=0 /D_ITERATOR_DEBUG_LEVEL=0 /Ob2 /Oi /GL

RBJIT_LDFALGS = /libpath:$(LLVM_PREFIX)/lib /LTCG /DYNAMICBASE /NXCOMPAT /SAFESEH
